...
export default function() {
    group("/api/visits/{visitId}", () => {
        ...
        body = {"date": "date", "description": "string", "id": "integer", "petId": "integer"};
    ...
    group("/api/vets/{vetId}", () => {
        ...
        // Request No. 2
        // TODO: edit the parameters of the request body.
        body = {"firstName": "string", "lastName": "string", "specialties": "list", "id": "integer"};
        params = {headers: {"Content-Type": "application/json"}};
        request = http.put(url, body, params);
        check(request, {
    ...
    group("/api/pets/{petId}", () => {
        ...
        // Request No. 2
        // TODO: edit the parameters of the request body.
        body = {"name": "string", "birthDate": "date", "type": {"name": "string", "id": "integer"}, "id": "integer", "ownerId": "integer", "visits": "list"};
        params = {headers: {"Content-Type": "application/json"}};
        request = http.put(url, body, params);
        check(request, {
            "Pet details found and returned.": (r) => r.status === 200
    ...
    group("/api/owners/{ownerId}", () => {
        ...
        // Request No. 2
        // TODO: edit the parameters of the request body.
        body = {"firstName": "string", "lastName": "string", "address": "string", "city": "string", "telephone": "string"};
        params = {headers: {"Content-Type": "application/json"}};
        request = http.put(url, body, params);
        check(request, {
    ...
    group("/api/owners/{ownerId}/pets/{petId}", () => {
        ...
        // Request No. 2
        // TODO: edit the parameters of the request body.
        body = {"name": "string", "birthDate": "date", "type": {"name": "string", "id": "integer"}};
        params = {headers: {"Content-Type": "application/json"}};
        request = http.put(url, body, params);
        check(request, {
